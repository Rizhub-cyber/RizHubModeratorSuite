...
local ConfigurationFolder = "RizHub Interface Suite"
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	LoadingFrame.Title.Text = Settings.LoadingTitle or "RizHub Interface Suite"
	LoadingFrame.Subtitle.Text = Settings.LoadingSubtitle or "by RizHub"
